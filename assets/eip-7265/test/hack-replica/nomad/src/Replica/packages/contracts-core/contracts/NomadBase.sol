...
import {Initializable} from "../../../node_modules/@openzeppelin/contracts-upgradeable/proxy/Initializable.sol";
...
abstract contract NomadBase is Initializable, OwnableUpgradeable {
    ...
    function _isUpdaterSignature(
        ...
        _digest = MessageHashUtils.toEthSignedMessageHash(_digest);
